...
- [Rainbow Badges](https://github.com/Parply/readme-badge-colouriser) - Updates [shields.io](https://shields.io/) badges in `README.md` to have the colours of a rainbow.
