...
- [Metrics](https://github.com/lowlighter/metrics) - [GitHub Action] Image generator for 20+ statistics from various sources including GitHub, Music (Spotify and Apple Music), Wakatime, and others
